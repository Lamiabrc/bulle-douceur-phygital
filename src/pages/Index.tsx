...
import { Sparkles, ArrowRight, HeartHandshake, ShieldCheck, BarChart3, Brain, Mic, Users } from "lucide-react";

/**
 * 🌟 Page d'accueil QVT Box — Refonte premium 2025
 * - Hero ultra visuel
 * - Intégration ZÉNA Emotion AI
 * - Présentation du SaaS QVT Box
 * - Cohérence totale avec ton branding : bulles, halos, bienveillance
 * - Optimisé pour les RH & managers
 */
